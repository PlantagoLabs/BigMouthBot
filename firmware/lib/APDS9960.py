...
class PROX(I2CEX):
    ...
    def eLEDBoost(self):
        ...
        :getter: Returns the LED Boost (0 -3)
        :setter: Sets the LED Boost(0 -3)
        :type: int
        ...
        """
        #APDS9960_REG_CONTROL = const(0x8f)
        val=super().__readByte(0x90) & 0b00110000
        val=val >> 4
        return val
  
       
    @eLEDCurrent.setter
    def eLEDBoost(self, eBoost):
        #APDS9960_REG_CONTROL = const(0x8f)
        val=super().__readByte(0x90)        
